...
function QuienesSomos() {
  return (
    <section className="pt-2 mb-10 h-5/6 grid grid-cols-2 bg-white dark:bg-gradient-to-b from-cyan-800 via-gray-700 to-cyan-800 ">
      <div className="my-32">
        <h3 className='mx-6 pt-2 py-8 px-5 class=" text-2xl font-extrabold leading-none tracking-tight text-gray-900 md:text-3xl md:mt-0 lg:text-5xl dark:text-white'>
      ...
      <div className="flex flex-col justify-center items-center">
        ...
        <button className="text-white font-extrabold text-3xl bg-sky-400 p-3 rounded-lg shadow-lg hover:shadow-xl hover:transition-transform hover:scale-105">
          Agenda una cita
        </button>
      </div>
    </section>
